...
<form action method="POST" >
			<div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Date from</label>
                        <div class="col-sm-9">
				<input class="form-control" id="date" name="Datefrom" placeholder="YYYY-MM-DD" type="text" />
                        </div>
                    </div> 
		    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Date To</label>
                        <div class="col-sm-9">
				<input class="form-control" id="date" name="Dateto" placeholder="YYYY-MM-DD" type="text" />
                        </div>
                    </div>
		<div class="form-group">
...
<div w3-include-html="surgery1.php"></div> 
<div w3-include-html="surgery2.php"></div> 
</form>	
</div>
<!-- Auto width -->
