...
<li class="active"><a href="insem.php">INSEMINATION</a></li>
...
<div class="col-sm-6">
		...
		<form action="insem1.php" method="POST" >
		 ...
		 <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Organ Condition</label>
                        <div class="col-sm-9">
