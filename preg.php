...
<li class="active"><a href="preg.php">PREGNANCY</a></li>
...
<div class="col-sm-6">
		...
		<form action="preg1.php" method="POST" >
		    ...
		    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Checkup output</label>
                        <div class="col-sm-9">
